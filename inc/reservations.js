...
module.exports = {
    ...
    getReservations(req){
        ...
        return new Promise((resolve, reject) => {
            ...
            paginationClass.getPage(page).then(data => {

                resolve({

                    data,
                    links: paginationClass.getNavigation(req.query)
    ...
    render(req, res, error, success){
        ...
        background: 'images/img_bg_2.jpg', h1:'Reserve uma mesa!', body: req.body,
        error, success});
    ...
    chart(req){
        ...
        return new Promise((resolve, reject) => {
            ...
            ORDER BY YEAR(date) DESC, MONTH(date) DESC;`, [
                ...
                req.query.dtstart, req.query.dtend
